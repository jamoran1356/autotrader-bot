  ...
  return (
    <div className="page-shell space-y-8">
      <section className="space-y-4">
        <span className="eyebrow">Create Bot</span>
        <h1 className="text-4xl font-semibold tracking-tight">Register a bot as a product inside the marketplace</h1>
        <p className="max-w-3xl text-base leading-8 text-[var(--muted)]">
          This screen prepares the flow to list bots with identity, monetization, and clear execution rules before full testnet deployment.
        </p>
      </section>
      ...
      <Card>
        <CardHeader>
          ...
          <CardTitle className="mt-3 text-2xl font-semibold">Minimum listing data</CardTitle>
        </CardHeader>
